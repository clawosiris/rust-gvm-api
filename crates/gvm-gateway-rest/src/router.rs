...
use crate::{
    ...
    supporting_resources::{
        ...
        delete_note_docs, delete_override, delete_override_docs, delete_ticket, delete_ticket_docs,
        ...
        list_tickets_docs, list_vulnerabilities, list_vulnerabilities_docs, update_note,
        update_note_docs, update_override, update_override_docs, update_ticket, update_ticket_docs,
    },
...
fn documented_router() -> ApiRouter<GatewayService> {
    ApiRouter::new()
        ...
        .api_route(
            "/api/v1/tickets/{id}",
            put_with(update_ticket, update_ticket_docs),
        )
        .api_route(
            "/api/v1/tickets/{id}",
            delete_with(delete_ticket, delete_ticket_docs),
        )
