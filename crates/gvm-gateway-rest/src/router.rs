...
use crate::{
    ...
    create_note_docs,
    create_override,
    create_override_docs,
    delete_note,
    delete_note_docs,
    delete_override,
    delete_override_docs,
    get_filter,
    get_filter_docs,
    get_host,
    get_host_docs,
    ...
    list_notes_docs,
    list_nvt_families,
    list_nvt_families_docs,
    list_nvts,
    list_nvts_docs,
    list_overrides,
    list_overrides_docs,
    list_report_formats,
    list_report_formats_docs,
    list_tags,
    list_tags_docs,
    list_tickets,
    list_tickets_docs,
    list_vulnerabilities,
    list_vulnerabilities_docs,
    update_note,
    update_note_docs,
    update_override,
...
fn documented_router() -> ApiRouter<GatewayService> {
    ApiRouter::new()
        ...
        .api_route(
            "/api/v1/tickets",
            post_with(create_ticket, create_ticket_docs),
        )
        .api_route(
            "/api/v1/tickets/{id}",
