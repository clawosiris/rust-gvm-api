...
use gvm_gmp::{
    commands::{
        aggregates::{get_aggregates as get_aggregates_cmd, GetAggregatesOpts},
        alerts::{
    ...
    responses::{
        ...
        GetAggregatesResponse, GetAlertsResponse, GetCredentialsResponse, GetFeedsResponse,
...
use crate::conversions::{
    aggregates_from_gmp, alert_from_gmp, credential_from_gmp, feed_from_gmp, filter_from_gmp,
    group_from_gmp, host_from_gmp, map_gvm_error, map_parse_error, note_from_gmp,
    nvt_family_from_gmp, nvt_from_gmp, override_from_gmp, parse_alert_condition, parse_alert_event,
