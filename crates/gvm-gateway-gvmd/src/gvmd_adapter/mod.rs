...
use crate::conversions::{
    ...
    note_from_gmp, nvt_family_from_gmp, nvt_from_gmp, oci_image_target_from_gmp, override_from_gmp,
    parse_alert_condition, parse_alert_event, parse_alert_method, parse_alive_test,
    parse_asset_type, parse_config_usage_type, parse_credential_type, parse_entity_id,
